...
Pong::Pong(){
  ...
  win = SDL_CreateWindow("Pong V2 By Wei",
  ...
  leftPaddle = new Paddle(40, SCREEN_HEIGHT/2-Paddle::HEIGHT/2, 10);
  rightPaddle = new Paddle(SCREEN_WIDTH-(40+Paddle::WIDTH), SCREEN_HEIGHT/2-Paddle::HEIGHT/2, 10);
...
void Pong::render(){
  ...
  SDL_Rect paddle1 = { leftPaddle->x,
                       leftPaddle->y,
                       Paddle::WIDTH, Paddle::HEIGHT};
  SDL_RenderFillRect(ren, &paddle1);

  SDL_Rect paddle2 = { rightPaddle->x,
                       rightPaddle->y,
                       Paddle::WIDTH, Paddle::HEIGHT};
  ...
  renderTexture(font_image_left_score,
                ren, SCREEN_WIDTH*4/10, SCREEN_HEIGHT/12);
  ...
  renderTexture(font_image_right_score,
                ren,
                SCREEN_WIDTH*6/10 - 12, SCREEN_HEIGHT/12);
 if(left_score == 5){
   renderTexture(font_image_winner,
                 ren, SCREEN_WIDTH/2, SCREEN_HEIGHT/4);
   renderTexture(font_image_restart,
                 ren, SCREEN_WIDTH/2, SCREEN_HEIGHT/3);
    left_score = 0;
    right_score = 0;
    left_score_changed = true;
    right_scoure_changed = true;
